<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sellerhomepage.aspx.vb" Inherits="stoptoshop.Sellerhomepage" %>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width:250px">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="dropdown mt-3">
                        <asp:Label ID="Lblname" runat="server" CssClass="lbln"></asp:Label>
                        <asp:Button ID="Button4" runat="server" Text="Bidding" CssClass="la" /><br />
                        <asp:Button ID="Button5" runat="server" Text="Orders" CssClass="la" /><br />
