<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cpurchase.aspx.vb" Inherits="stoptoshop.cpurchase" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="g2">
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button2" runat="server" Text="Received" class="btn btn-primary" /></td>
