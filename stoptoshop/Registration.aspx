<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registration.aspx.vb" Inherits="stoptoshop.Registration" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <asp:Label ID="Label11" runat="server" Text="Profile Image" class="form-label"></asp:Label><br />
